...
namespace tvn_cosine.ai.test.learning.fol
{
    ...
    public class UnifierTest
    {
        ...
        private IDictionary<Variable, Term> theta;
        ...
        public void testFailureIfThetaisNull()
        {
            ...
            theta = null;
            IDictionary<Variable, Term> result = unifier.unify(var, sentence, theta);
        ...
        public void testThetaPassedBackIfXEqualsYBothVariables()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(var1, var2, theta);
        ...
        public void testVariableEqualsConstant()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(var1, constant, theta);
            Assert.AreEqual(theta, result);
            Assert.AreEqual(1, theta.Keys.Count);
            Assert.IsTrue(theta.Keys.Contains(var1));
        ...
        public void testSimpleVariableUnification()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(p1, p2, theta);
            Assert.AreEqual(theta, result);
            Assert.AreEqual(1, theta.Keys.Count);
            Assert.IsTrue(theta.Keys.Contains(new Variable("x"))); // x =
        ...
        public void testKnows1()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(query, johnKnowsJane, theta);
            Assert.AreEqual(theta, result);
            Assert.IsTrue(theta.Keys.Contains(new Variable("x"))); // x =
        ...
        public void testCascadedOccursCheck()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(s1, s2);
        ...
        public void testTermEquality()
        {
            ...
            IDictionary<Variable, Term> result = unifier.unify(te1, te2);
