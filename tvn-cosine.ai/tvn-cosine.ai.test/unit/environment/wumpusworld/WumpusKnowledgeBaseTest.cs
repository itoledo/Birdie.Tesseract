namespace tvn_cosine.ai.test.unit.environment.wumpusworld
{
    ...
    @Test
        public void testAskSafeRooms()
        {
            ...
            step(KB, new AgentPercept(false, false, false, false, false), t);
            Assert.assertEquals(new HashSet<Room>() { { add(new Room(1, 1)); add(new Room(1, 2)); add(new Room(2, 1));
        }
    }, KB.askSafeRooms(t));
    ...
    public void testAskUnvistedRooms()
{
    ...
    KB = new WumpusKnowledgeBase(dpll, 2);
    step(KB, new AgentPercept(false, false, false, false, false), t);
    Assert.assertEquals(new HashSet<Room>() { { add(new Room(1, 2)); add(new Room(2, 1)); add(new Room(2, 2));
    ...
    public void testAskPossibleWumpusRooms()
{
    ...
    KB = new WumpusKnowledgeBase(dpll, 2);
    step(KB, new AgentPercept(false, false, false, false, false), t);
    Assert.assertEquals(new HashSet<Room>() { { add(new Room(2, 2));
