...
////            step(KB, new AgentPercept(false, false, false, false, false), t);
////            Assert.AreEqual(Factory.CreateSet<Room>() { { add(new Room(1, 1)); add(new Room(1, 2)); add(new Room(2, 1));
////        }
////    }, KB.askSafeRooms(t));
...
////        step(KB, new AgentPercept(true, false, false, false, false), t);		
////		Assert.AreEqual(Factory.CreateSet<Room>() {{add(new Room(1,1));}}, KB.askSafeRooms(t));
...
////    KB = new WumpusKnowledgeBase(dpll, 2);
////    step(KB, new AgentPercept(false, false, false, false, false), t);
////    Assert.AreEqual(Factory.CreateSet<Room>() { { add(new Room(1, 2)); add(new Room(2, 1)); add(new Room(2, 2));
...
////		Assert.AreEqual(Factory.CreateSet<Room>() {{add(new Room(1,2)); add(new Room(2,2));}}, KB.askUnvisitedRooms(t));
////	}
...
////    KB = new WumpusKnowledgeBase(dpll, 2);
////    step(KB, new AgentPercept(false, false, false, false, false), t);
////    Assert.AreEqual(Factory.CreateSet<Room>() { { add(new Room(2, 2));
////}}, KB.askPossibleWumpusRooms(t));	
		
////		KB =  new WumpusKnowledgeBase(dpll, 2);

////        step(KB, new AgentPercept(true, false, false, false, false), t); 		
////		Assert.AreEqual(Factory.CreateSet<Room>() {{add(new Room(1,2)); add(new Room(2, 1));}}, KB.askPossibleWumpusRooms(t));		

////		KB =  new WumpusKnowledgeBase(dpll, 3);

////        step(KB, new AgentPercept(false, false, false, false, false), t);		
////		Assert.AreEqual(Factory.CreateSet<Room>() {{add(new Room(1,3)); add(new Room(2,2)); add(new Room(2,3)); add(new Room(3,1)); add(new Room(3,2)); add(new Room(3,3));}}, KB.askPossibleWumpusRooms(t));
////		KB.makeActionSentence(new Forward(new AgentPosition(1, 1, AgentPosition.Orientation.FACING_EAST)), t); // Move agent to [2,1]		
////	}
...
////        step(KB, new AgentPercept(true, false, false, false, false), t); 		
////		Assert.AreEqual(Factory.CreateSet<Room>() {{add(new Room(1,1)); add(new Room(1,2)); add(new Room(2, 1)); add(new Room(2,2));}}, KB.askNotUnsafeRooms(t));		
////	}
