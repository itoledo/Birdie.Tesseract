...
public class LogTypeTest {
	...
	private ProbabilityFactory<?> probFactory = ProbabilityFactory.make(LogProbabilityNumber.class);
	...
	public void testIsZero2() {
		ProbabilityNumber testValue0 = probFactory.valueOf(BigDecimal.ZERO);
		assertEquals(testValue0.isZero(), true);
	}
