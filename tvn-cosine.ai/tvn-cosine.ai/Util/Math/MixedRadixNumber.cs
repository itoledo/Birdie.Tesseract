...
namespace tvn.cosine.ai.Util.Math
{
    ...
    /// See <see cref="http://demonstrations.wolfram.com/MixedRadixNumberRepresentations/"/>
    /// </summary>
    public class MixedRadixNumber
    {
        ...
        {
            this.value = value;
            this.radices = new int[radices.Count];
        ...
        public int getCurrentNumeralValue(int atPosition)
        {
            ...
            throw new ArgumentException("Argument atPosition must be >=0 and < " + radices.Length);
        }
