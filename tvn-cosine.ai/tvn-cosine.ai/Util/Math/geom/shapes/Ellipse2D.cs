...
namespace tvn.cosine.ai.util.math.geom.shapes
{
    ...
    public class Ellipse2D : IGeometric2D
    {
        ...
        public Point2D randomPoint()
        {
            ...
            double delta = Math.Abs(verticalLength * Math.Sin(Math.Acos(x / horizontalLength)));
        ...
        public bool isInside(Point2D point)
        {
            ...
            {
                double delta = Math.Abs(verticalLength * Math.Sin(Math.Acos((transformedPoint.getX() - center.getX()) / horizontalLength)));
    ...
    public Rect2D getBounds()
        {
           ...
           double boundX = Math.Sqrt(horizontalLength * horizontalLength * cosAngle * cosAngle + verticalLength * verticalLength * sinAngle * sinAngle);
           double boundY = Math.Sqrt(horizontalLength * horizontalLength * sinAngle * sinAngle + verticalLength * verticalLength * cosAngle * cosAngle);
