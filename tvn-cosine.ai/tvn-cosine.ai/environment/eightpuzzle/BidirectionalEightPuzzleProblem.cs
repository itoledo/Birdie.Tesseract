 ...
 * 
 */
public class BidirectionalEightPuzzleProblem : GeneralProblem<EightPuzzleBoard, Action>
	...
	public BidirectionalEightPuzzleProblem(EightPuzzleBoard initialState) {
		base(initialState, EightPuzzleFunctions::getActions, EightPuzzleFunctions::getResult,
