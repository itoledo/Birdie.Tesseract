...
namespace tvn.cosine.ai.environment.map
{
    ...
    public class BidirectionalMapProblem : GeneralProblem<string, MoveToAction>, IBidirectionalProblem<string, MoveToAction>
    {
        ...
        {
            reverseProblem = new GeneralProblem<string, MoveToAction>(goalState, MapFunctions.createReverseActionsFunction(map),
                    MapFunctions.createResultFunction(), initialState.Equals,
