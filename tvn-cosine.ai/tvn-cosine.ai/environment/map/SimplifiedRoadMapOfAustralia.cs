...
public class SimplifiedRoadMapOfAustralia : ExtendableMap {
	...
	public static readonly string ALICE_SPRINGS = "AliceSprings";
	public static readonly string BRISBANE = "Brisbane";
	public static readonly string BROKEN_HILL = "BrokenHill";
	...
	public static readonly string COOBER_PEDY = "CooberPedy";
	...
	public static readonly string HALLS_CREEK = "HallsCreek";
	...
	public static readonly string LAKES_ENTRANCE = "LakesEntrance";
	...
	public static readonly string MOUNT_GAMBIER = "MountGambier";
	public static readonly string MT_ISA = "MtIsa";
	...
	public static readonly string PORT_AUGUSTA = "PortAugusta";
	public static readonly string PORT_HEDLAND = "PortHedland";
	public static readonly string PORT_LINCOLN = "PortLincoln";
	public static readonly string PORT_MACQUARIE = "PortMacquarie";
	...
	public static readonly string TENNANT_CREEK = "TennantCreek";
	public static readonly string TOWNSVILLE = "Townsville";
	public static readonly string WAGGA_WAGGA = "WaggaWagga";
