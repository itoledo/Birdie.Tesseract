...
namespace tvn.cosine.ai.environment.nqueens
{
    ...
    public class NQueensFunctions
    {
        ...
        public static IProblem<NQueensBoard, QueenAction> createCompleteStateFormulationProblem(int boardSize, NQueensBoard.Config config)
        {
         ...
         */
        public static IList<QueenAction> getIFActions(NQueensBoard state)
        {
            IList<QueenAction> actions = new List<QueenAction>();
         ...
         */
        public static IList<QueenAction> getCSFActions(NQueensBoard state)
        {
            IList<QueenAction> actions = new List<QueenAction>();
         ...
         * the board.
         */
        public static HeuristicEvaluationFunction<Node<NQueensBoard, QueenAction>> createAttackingPairsHeuristicFunction()
        {
