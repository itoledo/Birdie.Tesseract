...
public class TableDrivenVacuumAgent : AbstractAgent {
	...
	// PRIVATE METHODS
	//
	private static IDictionary<List<Percept>, Action> getPerceptSequenceActions() {
		IDictionary<List<Percept>, Action> perceptSequenceActions = new Dictionary<List<Percept>, Action>();
