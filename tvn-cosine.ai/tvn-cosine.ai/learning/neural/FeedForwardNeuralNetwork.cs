...
public class FeedForwardNeuralNetwork : FunctionApproximator {
	...
	public static readonly string UPPER_LIMIT_WEIGHTS = "upper_limit_weights";
	public static readonly string LOWER_LIMIT_WEIGHTS = "lower_limit_weights";
	public static readonly string NUMBER_OF_OUTPUTS = "number_of_outputs";
	public static readonly string NUMBER_OF_HIDDEN_NEURONS = "number_of_hidden_neurons";
	public static readonly string NUMBER_OF_INPUTS = "number_of_inputs";
	//
