...
namespace tvn.cosine.ai.libsvm
{
    ...
    class Solver
    {
        ...
        public const byte LOWER_BOUND = 0;
        public const byte UPPER_BOUND = 1;
        public const byte FREE = 2;
        public byte[] alpha_status;    // LOWER_BOUND, UPPER_BOUND, FREE
        public double[] alpha;
        public QMatrix Q;
        public double[] QD;
        public double eps;
        ...
        public void Solve(int l, QMatrix Q, double[] p_, sbyte[] y_,
    ...
    public class svm
    {
        ...
        //
        public const int LIBSVM_VERSION = 311;
        public static readonly IRandom rand = CommonFactory.CreateRandom();

        private static svm_print_interface svm_print_stdout = new Defaultsvm_print_interface();
        ...
        static readonly string[] kernel_type_table =
    {
        ...
        {
            System.IO.StreamWriter fp = new System.IO.StreamWriter(System.IO.File.OpenWrite(model_file_name));
        ...
        {
            return svm_load_model(new System.IO.StreamReader(model_file_name));
        }

        public static svm_model svm_load_model(System.IO.StreamReader fp)
        {
            // read parameters 
            svm_model model = new svm_model();
