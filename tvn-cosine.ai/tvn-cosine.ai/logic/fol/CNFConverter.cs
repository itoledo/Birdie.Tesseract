...
namespace tvn.cosine.ai.logic.fol
{
    ...
    class RemoveQuantifiers : FOLVisitor
    {
        ...
        public object visitQuantifiedSentence(QuantifiedSentence sentence, object arg)
        {
            ...
            ISet<Variable> universalScope = (ISet<Variable>)arg;
            ...
            throw new Exception("Unhandled Quantifier:" + sentence.getQuantifier());
        }
    }
    ...
    class CNFConstructor : FOLVisitor
    {
        ...
        public object visitVariable(Variable variable, object arg)
        {
            ...
            throw new Exception("visitVariable() should not be called.");
        }

        public object visitConstant(Constant constant, object arg)
        {
            // This should not be called
            throw new Exception("visitConstant() should not be called.");
        }

        public object visitFunction(Function function, object arg)
        {
            // This should not be called
            throw new Exception("visitFunction() should not be called.");
        }
