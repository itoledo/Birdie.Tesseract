...
namespace tvn.cosine.ai.logic.propositional.inference
{
    ...
    public class DPLLSatisfiable : DPLL
    {
        ...
        public bool dpllSatisfiable(Sentence s)
        {
            ...
            IList<PropositionSymbol> symbols = getPropositionSymbolsInSentence(s);
        ...
        public bool dpll(ISet<Clause> clauses, IList<PropositionSymbol> symbols, Model model)
        {
            ...
            if (pAndValue != null)
            {
                ...
                return dpll(clauses, minus(symbols, pAndValue.First), model.union(pAndValue.First, pAndValue.Second));
            }
