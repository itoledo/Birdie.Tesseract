...
public class PLFCEntails {
	...
	public bool plfcEntails(KnowledgeBase kb, PropositionSymbol q) {
		...
		// symbols
		IDictionary<PropositionSymbol, Boolean> inferred = initializeInferred(kb);
		...
		IDictionary<PropositionSymbol, ISet<Clause>> pToClausesWithPInPremise = initializeIndex(
				count, inferred);
	...
	protected IDictionary<PropositionSymbol, Boolean> initializeInferred(KnowledgeBase kb) {
		// inferred <- a table, where inferred[s] is initially false for all
		// symbols
		IDictionary<PropositionSymbol, Boolean> inferred = new Dictionary<PropositionSymbol, Boolean>();
	...
	// clauses in KB.
	protected Queue<PropositionSymbol> initializeAgenda(IDictionary<Clause, int> count) {
		// agenda <- a queue of symbols, initially symbols known to be true in
		// KB
		Queue<PropositionSymbol> agenda = new LinkedList<PropositionSymbol>();
		for (Clause c : count.Keys) {
	...
	protected IDictionary<PropositionSymbol, ISet<Clause>> initializeIndex(
			IDictionary<Clause, int> count, IDictionary<PropositionSymbol, Boolean> inferred) {
		IDictionary<PropositionSymbol, ISet<Clause>> pToClausesWithPInPremise = new Dictionary<PropositionSymbol, ISet<Clause>>();
		for (PropositionSymbol p : inferred.Keys) {
