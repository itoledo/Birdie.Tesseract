...
namespace tvn.cosine.ai.logic.propositional.parsing.ast
{
    ...
    {
        public static Connective NOT = new Connective("~", 10); // i.e. highest to lowest precedence.
        public static Connective AND = new Connective("&", 8);
        public static Connective OR = new Connective("|", 6);
        public static Connective IMPLICATION = new Connective("=>", 4);
        public static Connective BICONDITIONAL = new Connective("<=>", 2);
        ...
        // PRIVATE
        //
        private static readonly ISet<char> _connectiveLeadingChars = Util.createSet<char>('~', '&', '|', '=', '<');
        private static readonly ISet<char> _connectiveChars = Util.createSet<char>('~', '&', '|', '=', '<', '>');
