...
{
    public interface CategoricalDistributionIterator : Iterator
    {  }
     ...
     */
    public interface CategoricalDistribution : ProbabilityMass
    { 
        /**
         ...
         *         values.
         */
        CategoricalDistribution marginal(params RandomVariable[] vars);
         ...
         */
        CategoricalDistribution multiplyByPOS(CategoricalDistribution multiplier, params RandomVariable[] prodVarOrder);
