...
namespace tvn.cosine.ai.probability
{
     ...
     */
    public interface CategoricalDistribution<T> : ProbabilityMass<T>
    {
        /**
         ...
         */
        CategoricalDistribution<T> normalize();
         ...
         *             of the dividend.
         */
        CategoricalDistribution<T> divideBy(CategoricalDistribution<T> divisor);
         ...
         *      RandomVariable...)
         */
        CategoricalDistribution<T> multiplyBy(CategoricalDistribution<T> multiplier);
         ...
         */
        void iterateOver(Iterator<T> cdi);
