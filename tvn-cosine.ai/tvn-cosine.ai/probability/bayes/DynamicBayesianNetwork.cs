...
namespace tvn.cosine.ai.probability.bayes
{
     ...
     * 
     */
    public interface DynamicBayesianNetwork<T> : BayesianNetwork<T>
    { 
        /**
         * 
         ...
         */
        BayesianNetwork<T> getPriorNetwork();
         ...
         */
        IList<RandomVariable> getX_1_VariablesInTopologicalOrder();
         ...
         *         X<sub>1</sub>.
         */
        IDictionary<RandomVariable, RandomVariable> getX_0_to_X_1();
         ...
         *         X<sub>0</sub>.
         */
        IDictionary<RandomVariable, RandomVariable> getX_1_to_X_0();
