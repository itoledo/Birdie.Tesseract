...
namespace tvn.cosine.ai.probability.hmm
{
     ...
     * 
     */
    public interface HiddenMarkovModel<T>
    {
         ...
         * @return the sensor model in matrix form.
         */
        IDictionary<T, Matrix> getSensorModel();
         ...
         *         sensor model.
         */
        Matrix getEvidence(IList<AssignmentProposition<T>> evidence);
         ...
         *         distribution.
         */
        Matrix convert(CategoricalDistribution<T> fromCD);
         ...
         *         vector.
         */
        CategoricalDistribution<T> convert(Matrix fromMessage);
         ...
         */
        IList<CategoricalDistribution<T>> convert(IList<Matrix> matrixs);
