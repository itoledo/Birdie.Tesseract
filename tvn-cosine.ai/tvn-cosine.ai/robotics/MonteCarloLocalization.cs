...
namespace tvn.cosine.ai.robotics
{
        ...
        where R : IMclRangeReading<R, V>
    {
        ...
        private RandVar<int> sampleIndexes;
         ...
         */
        public MonteCarloLocalization(IMclMap<P, V, M, R> map, Random randomizer)
        {
            this.map = map;
        ...
        public ISet<P> generateCloud(int N)
        {
            ...
            sampleIndexes = new RandVar<int>(SAMPLE_INDEXES_NAME, new FiniteIntegerDomain(indexes));
            return samples;
        }
