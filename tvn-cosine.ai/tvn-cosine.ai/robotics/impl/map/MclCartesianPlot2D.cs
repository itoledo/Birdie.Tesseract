 namespace aima.core.robotics.impl.map;
...
/**
 * This class : the interface {@link IMclMap} using the classes {@link Angle} and {@link AbstractRangeReading}.<br/>
 ...
 */
public final class MclCartesianPlot2D<P : IPose2D<P,M>,M : IMclMove<M>,R : AbstractRangeReading> : IMclIDictionary<P,Angle,M,AbstractRangeReading> {

	/**
	 * This is the identifier that is used to find a group of obstacles in the map file.
	 */
	public static readonly string OBSTACLE_ID = "obstacles";
	/**
	 * This is the identifier that is used to find a group of areas in the map file.
	 */
	public static readonly string AREA_ID = "validMovementArea";
