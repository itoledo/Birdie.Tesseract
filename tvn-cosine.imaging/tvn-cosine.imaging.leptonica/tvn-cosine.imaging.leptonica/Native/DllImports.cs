...
namespace Leptonica.Native
{
    internal class DllImports
    {
        ...
        /* 
         ...
         internal static  extern BOXA* boxaSelectByWHRatio(HandleRef boxas, float ratio, int relation, l_int32* pchanged);
         ...
         internal static  extern PIX* boxaDisplayTiled(HandleRef boxas, PIXA* pixa, int maxwidth, int linewidth, float scalefactor, int background, int spacing, int border);
         ...
         internal static  extern CCBORD* pixGetCCBorders(PIX* pixs, BOX* box);
         ...
         internal static  extern PTA* getCutPathForHole(PIX* pix, PTA* pta, BOX* boxinner, l_int32* pdir, l_int32* plen);
         ...
         internal static  extern int pixFindColorRegions(PIX* pixs, PIX* pixm, int factor, int lightthresh, int darkthresh, int mindiff, int colordiff, float edgefract, l_float32* pcolorfract, PIX** pcolormask1, PIX** pcolormask2, PIXA* pixadb);
         ...
         internal static  extern int pixComparePhotoRegionsByHisto(PIX* pix1, PIX* pix2, BOX* box1, BOX* box2, float minratio, int factor, int nx, int ny, l_float32* pscore, int debugflag);
         internal static  extern int pixGenPhotoHistos(PIX* pixs, BOX* box, int factor, float thresh, int nx, int ny, NUMAA** pnaa, l_int32* pw, l_int32* ph, int debugflag);
         ...
         internal static  extern int pixDecideIfPhotoImage(PIX* pix, int factor, int nx, int ny, float thresh, NUMAA** pnaa, PIXA* pixadebug);
         internal static  extern int compareTilesByHisto(NUMAA* naa1, NUMAA* naa2, float minratio, int w1, int h1, int w2, int h2, l_float32* pscore, PIXA* pixadebug);
         internal static  extern int pixCompareGrayByHisto(PIX* pix1, PIX* pix2, BOX* box1, BOX* box2, float minratio, int maxgray, int factor, int nx, int ny, l_float32* pscore, int debugflag);
         ...
         internal static  extern BOXA* pixConnComp(PIX* pixs, PIXA** ppixa, int connectivity);
         internal static  extern BOXA* pixConnCompPixa(PIX* pixs, PIXA** ppixa, int connectivity);
         internal static  extern BOXA* pixConnCompBB(PIX* pixs, int connectivity);
         ...
         internal static  extern BOX* pixSeedfillBB(PIX* pixs, L_STACK* stack, int x, int y, int connectivity);
         internal static  extern BOX* pixSeedfill4BB(PIX* pixs, L_STACK* stack, int x, int y);
         internal static  extern BOX* pixSeedfill8BB(PIX* pixs, L_STACK* stack, int x, int y);
         ...
         internal static  extern PIX* pixReadJp2k( const char* filename, uint reduction, BOX* box, int hint, int debug );
         internal static  extern PIX* pixReadStreamJp2k(FILE* fp, uint reduction, BOX* box, int hint, int debug);
         ...
         internal static  extern PIXA* pixaMorphSequenceByComponent(PIXA* pixas, const char* sequence, int minw, int minh );
         ...
         internal static  extern PIXA* pixaMorphSequenceByRegion(PIX* pixs, PIXA* pixam, const char* sequence, int minw, int minh );
         ...
         internal static  extern PIXA* pixaExtendByMorph(PIXA* pixas, int type, int niters, SEL* sel, int include);
         internal static  extern PIXA* pixaExtendByScaling(PIXA* pixas, NUMA* nasc, int type, int include);
         ...
         internal static  extern PIX* pixGenTextlineMask(PIX* pixs, PIX** ppixvws, l_int32* ptlfound, PIXA* pixadb);
         internal static  extern PIX* pixGenTextblockMask(PIX* pixs, PIX* pixvws, PIXA* pixadb);
         internal static  extern BOX* pixFindPageForeground(PIX* pixs, int threshold, int mindist, int erasedist, int pagenum, int showmorph, int display, const char* pdfdir );
         internal static  extern int pixSplitIntoCharacters(PIX* pixs, int minw, int minh, BOXA** pboxa, PIXA** ppixa, PIX** ppixdebug);
         internal static  extern BOXA* pixSplitComponentWithProfile(PIX* pixs, int delta, int mindel, PIX** ppixdebug);
         internal static  extern PIXA* pixExtractTextlines(PIX* pixs, int maxw, int maxh, int minw, int minh, int adjw, int adjh, PIXA* pixadb);
         internal static  extern PIXA* pixExtractRawTextlines(PIX* pixs, int maxw, int maxh, int adjw, int adjh, PIXA* pixadb);
         internal static  extern int pixCountTextColumns(PIX* pixs, float deltafract, float peakfract, float clipfract, l_int32* pncols, PIXA* pixadb);
         internal static  extern int pixDecideIfText(PIX* pixs, BOX* box, l_int32* pistext, PIXA* pixadb);
         internal static  extern int pixFindThreshFgExtent(PIX* pixs, int thresh, l_int32* ptop, l_int32* pbot);
         internal static  extern int pixDecideIfTable(PIX* pixs, BOX* box, l_int32* pistable, PIXA* pixadb);
         internal static  extern PIX* pixPrepare1bpp(PIX* pixs, BOX* box, float cropfract, int outres);
         ...
         internal static  extern BOXA* boxaGetWhiteblocks(HandleRef boxas, BOX* box, int sortflag, int maxboxes, float maxoverlap, int maxperim, float fract, int maxpops);
         internal static  extern BOXA* boxaPruneSortedOnOverlap(HandleRef boxas, float maxoverlap);
         ...
         internal static  extern int pixClearInRect(PIX* pix, BOX* box);
         internal static  extern int pixSetInRect(PIX* pix, BOX* box);
         internal static  extern int pixSetInRectArbitrary(PIX* pix, BOX* box, uint val);
         internal static  extern int pixBlendInRect(PIX* pixs, BOX* box, uint val, float fract);
         ...
         internal static  extern int pixGetColorNearMaskBoundary(PIX* pixs, PIX* pixm, BOX* box, int dist, l_uint32* pval, int debug);
         ...
         internal static  extern NUMA* pixCountByRow(PIX* pix, BOX* box);
         internal static  extern NUMA* pixCountByColumn(PIX* pix, BOX* box);
         ...
         internal static  extern NUMA* pixAverageByRow(PIX* pix, BOX* box, int type);
         internal static  extern NUMA* pixAverageByColumn(PIX* pix, BOX* box, int type);
         internal static  extern int pixAverageInRect(PIX* pix, BOX* box, l_float32* pave);
         internal static  extern NUMA* pixVarianceByRow(PIX* pix, BOX* box);
         internal static  extern NUMA* pixVarianceByColumn(PIX* pix, BOX* box);
         internal static  extern int pixVarianceInRect(PIX* pix, BOX* box, l_float32* prootvar);
         internal static  extern NUMA* pixAbsDiffByRow(PIX* pix, BOX* box);
         internal static  extern NUMA* pixAbsDiffByColumn(PIX* pix, BOX* box);
         internal static  extern int pixAbsDiffInRect(PIX* pix, BOX* box, int dir, l_float32* pabsdiff);
         internal static  extern int pixAbsDiffOnLine(PIX* pix, int x1, int y1, int x2, int y2, l_float32* pabsdiff);
         internal static  extern int pixCountArbInRect(PIX* pixs, BOX* box, int val, int factor, l_int32* pcount);
         internal static  extern PIX* pixMirroredTiling(PIX* pixs, int w, int h);
         internal static  extern int pixFindRepCloseTile(PIX* pixs, BOX* box, int searchdir, int mindist, int tsize, int ntiles, BOX** pboxtile, int debug);
         ...
         internal static  extern NUMA* pixGetGrayHistogramInRect(PIX* pixs, BOX* box, int factor);
         ...
         internal static  extern NUMA* pixGetCmapHistogramInRect(PIX* pixs, BOX* box, int factor);
         ...
         internal static  extern int pixRowStats(PIX* pixs, BOX* box, NUMA** pnamean, NUMA** pnamedian, NUMA** pnamode, NUMA** pnamodecount, NUMA** pnavar, NUMA** pnarootvar);
         internal static  extern int pixColumnStats(PIX* pixs, BOX* box, NUMA** pnamean, NUMA** pnamedian, NUMA** pnamode, NUMA** pnamodecount, NUMA** pnavar, NUMA** pnarootvar);
         ...
         internal static  extern int pixGetMaxValueInRect(PIX* pixs, BOX* box, l_uint32* pmaxval, l_int32* pxmax, l_int32* pymax);
         ...
         internal static  extern int pixFindAreaFractionMasked(PIX* pixs, BOX* box, PIX* pixm, l_int32* tab, l_float32* pfract);
         ...
         internal static  extern int pixClipBoxToForeground(PIX* pixs, BOX* boxs, PIX** ppixd, BOX** pboxd);
         internal static  extern int pixScanForForeground(PIX* pixs, BOX* box, int scanflag, l_int32* ploc);
         internal static  extern int pixClipBoxToEdges(PIX* pixs, BOX* boxs, int lowthresh, int highthresh, int maxwidth, int factor, PIX** ppixd, BOX** pboxd);
         internal static  extern int pixScanForEdge(PIX* pixs, BOX* box, int lowthresh, int highthresh, int maxwidth, int factor, int scanflag, l_int32* ploc);
         ...
         internal static  extern int pixaAddBox(PIXA* pixa, BOX* box, int copyflag);
         ...
         internal static  extern BOXA* pixaGetBoxa(PIXA* pixa, int accesstype);
         ...
         internal static  extern int pixaWriteStreamInfo(FILE* fp, PIXA* pixa);
         internal static  extern int pixaReplacePix(PIXA* pixa, int index, PIX* pix, BOX* box);
         internal static  extern int pixaInsertPix(PIXA* pixa, int index, PIX* pixs, BOX* box);
         ...
         internal static  extern int pixaInitFull(PIXA* pixa, PIX* pix, BOX* box);
         ...
         internal static  extern int pixaaAddPix(PIXAA* paa, int index, PIX* pix, BOX* box, int copyflag);
         internal static  extern int pixaaAddBox(PIXAA* paa, BOX* box, int copyflag);
         internal static  extern int pixaaGetCount(PIXAA* paa, NUMA** pna);
         internal static  extern PIXA* pixaaGetPixa(PIXAA* paa, int index, int accesstype);
         internal static  extern BOXA* pixaaGetBoxa(PIXAA* paa, int accesstype);
         ...
         internal static  extern int pixaaInitFull(PIXAA* paa, PIXA* pixa);
         internal static  extern int pixaaReplacePixa(PIXAA* paa, int index, PIXA* pixa);
         internal static  extern int pixaaClear(PIXAA* paa);
         internal static  extern int pixaaTruncate(PIXAA* paa);
         internal static  extern PIXA* pixaRead( const char* filename );
         internal static  extern PIXA* pixaReadStream(FILE* fp);
         internal static  extern PIXA* pixaReadMem( const l_uint8* data, size_t size );
         internal static  extern int pixaWrite( const char* filename, PIXA *pixa );
         internal static  extern int pixaWriteStream(FILE* fp, PIXA* pixa);
         internal static  extern int pixaWriteMem(l_uint8** pdata, size_t* psize, PIXA* pixa);
         internal static  extern PIXA* pixaReadBoth( const char* filename );
         ...
         internal static  extern PIXA* pixaSelectBySize(PIXA* pixas, int width, int height, int type, int relation, l_int32* pchanged);
         ...
         internal static  extern PIXA* pixaSelectByPerimToAreaRatio(PIXA* pixas, float thresh, int type, l_int32* pchanged);
         internal static  extern PIX* pixSelectByPerimSizeRatio(PIX* pixs, float thresh, int connectivity, int type, l_int32* pchanged);
         internal static  extern PIXA* pixaSelectByPerimSizeRatio(PIXA* pixas, float thresh, int type, l_int32* pchanged);
         internal static  extern PIX* pixSelectByAreaFraction(PIX* pixs, float thresh, int connectivity, int type, l_int32* pchanged);
         internal static  extern PIXA* pixaSelectByAreaFraction(PIXA* pixas, float thresh, int type, l_int32* pchanged);
         internal static  extern PIX* pixSelectByWidthHeightRatio(PIX* pixs, float thresh, int connectivity, int type, l_int32* pchanged);
         internal static  extern PIXA* pixaSelectByWidthHeightRatio(PIXA* pixas, float thresh, int type, l_int32* pchanged);
         internal static  extern PIXA* pixaSelectByNumConnComp(PIXA* pixas, int nmin, int nmax, int connectivity, l_int32* pchanged);
         internal static  extern PIXA* pixaSelectWithIndicator(PIXA* pixas, NUMA* na, l_int32* pchanged);
         internal static  extern int pixRemoveWithIndicator(PIX* pixs, PIXA* pixa, NUMA* na);
         internal static  extern int pixAddWithIndicator(PIX* pixs, PIXA* pixa, NUMA* na);
         internal static  extern PIXA* pixaSelectWithString(PIXA* pixas, const char* str, int *perror );
         internal static  extern PIX* pixaRenderComponent(PIX* pixs, PIXA* pixa, int index);
         internal static  extern PIXA* pixaSort(PIXA* pixas, int sorttype, int sortorder, NUMA** pnaindex, int copyflag);
         internal static  extern PIXA* pixaBinSort(PIXA* pixas, int sorttype, int sortorder, NUMA** pnaindex, int copyflag);
         internal static  extern PIXA* pixaSortByIndex(PIXA* pixas, NUMA* naindex, int copyflag);
         internal static  extern PIXAA* pixaSort2dByIndex(PIXA* pixas, NUMAA* naa, int copyflag);
         internal static  extern PIXA* pixaSelectRange(PIXA* pixas, int first, int last, int copyflag);
         ...
         internal static  extern PIXA* pixaScaleToSize(PIXA* pixas, int wd, int hd);
         internal static  extern PIXA* pixaScaleToSizeRel(PIXA* pixas, int delw, int delh);
         internal static  extern PIXA* pixaScale(PIXA* pixas, float scalex, float scaley);
         internal static  extern PIXA* pixaAddBorderGeneral(PIXA* pixad, PIXA* pixas, int left, int right, int top, int bot, uint val);
         internal static  extern PIXA* pixaaFlattenToPixa(PIXAA* paa, NUMA** pnaindex, int copyflag);
         ...
         internal static  extern PIXA* pixaClipToPix(PIXA* pixas, PIX* pixs);
         ...
         internal static  extern PIXA* pixaConvertToSameDepth(PIXA* pixas);
         internal static  extern int pixaEqual(PIXA* pixa1, PIXA* pixa2, int maxdist, NUMA** pnaindex, l_int32* psame);
         internal static  extern PIXA* pixaRotateOrth(PIXA* pixas, int rotation);
         ...
         internal static  extern PIXA* pixaaDisplayTiledAndScaled(PIXAA* paa, int outdepth, int tilewidth, int ncols, int background, int spacing, int border);
         internal static  extern PIXA* pixaConvertTo1(PIXA* pixas, int thresh);
         internal static  extern PIXA* pixaConvertTo8(PIXA* pixas, int cmapflag);
         internal static  extern PIXA* pixaConvertTo8Color(PIXA* pixas, int dither);
         internal static  extern PIXA* pixaConvertTo32(PIXA* pixas);
         internal static  extern PIXA* pixaConstrainedSelect(PIXA* pixas, int first, int last, int nmax, int use_pairs, int copyflag);
         ...
         internal static  extern PIXA* pixaDisplayMultiTiled(PIXA* pixas, int nx, int ny, int maxw, int maxh, float scalefactor, int spacing, int border);
         ...
         internal static  extern PIXA* convertToNUpPixa( const char* dir, const char* substr, int nx, int ny, int tw, int spacing, int border, int fontsize );
         internal static  extern PIXA* pixaConvertToNUpPixa(PIXA* pixas, SARRAY* sa, int nx, int ny, int tw, int spacing, int border, int fontsize);
         internal static  extern int pixaCompareInPdf(PIXA* pixa1, PIXA* pixa2, int nx, int ny, int tw, int spacing, int border, int fontsize, const char* fileout );
         ...
         internal static  extern int pixacompAddBox(PIXAC* pixac, BOX* box, int copyflag);
         ...
         internal static  extern BOXA* pixacompGetBoxa(PIXAC* pixac, int accesstype);
         internal static  extern int pixacompGetBoxaCount(PIXAC* pixac);
         internal static  extern BOX* pixacompGetBox(PIXAC* pixac, int index, int accesstype);
         ...
         internal static  extern PIXA* pixaCreateFromPixacomp(PIXAC* pixac, int accesstype);
         ...
         internal static  extern BOX* ptaGetBoundingRegion(HandleRef pta);
         internal static  extern int ptaGetRange(HandleRef pta, l_float32* pminx, l_float32* pmaxx, l_float32* pminy, l_float32* pmaxy);
         internal static  extern PTA* ptaGetInsideBox(HandleRef ptas, BOX* box);
         ...
         internal static  extern PTA* ptaGetPixelsFromPix(PIX* pixs, BOX* box);
         ...
         internal static  extern PIXA* pixExtractBarcodes(PIX* pixs, int debugflag);
         ...
         internal static  extern BOXA* pixLocateBarcodes(PIX* pixs, int thresh, PIX** ppixb, PIX** ppixm);
         internal static  extern PIX* pixDeskewBarcode(PIX* pixs, PIX* pixb, BOX* box, int margin, int threshold, l_float32* pangle, l_float32* pconf);
         ...
         internal static  extern PIXA* pixaReadFiles( const char* dirname, const char* substr );
         internal static  extern PIXA* pixaReadFilesSA(SARRAY* sa);
         ...
         internal static  extern PIXA* recogExtractPixa(L_RECOG* recog);
         internal static  extern BOXA* recogDecode(L_RECOG* recog, PIX* pixs, int nlevels, PIX** ppixdb);
         ...
         internal static  extern int recogIdentifyPixa(L_RECOG* recog, PIXA* pixa, PIX** ppixdb);
         ...
         internal static  extern PIXA* recogFilterPixaBySize(PIXA* pixas, int setsize, int maxkeep, float max_ht_ratio, NUMA** pna);
         ...
         internal static  extern PIXA* pixaRemoveOutliers1(PIXA* pixas, float minscore, int mintarget, int minsize, PIX** ppixsave, PIX** ppixrem);
         internal static  extern int recogRemoveOutliers2(L_RECOG** precog, float minscore, int minsize, PIX** ppixsave, PIX** ppixrem);
         internal static  extern PIXA* pixaRemoveOutliers2(PIXA* pixas, float minscore, int minsize, PIX** ppixsave, PIX** ppixrem);
         internal static  extern PIXA* recogTrainFromBoot(L_RECOG* recogboot, PIXA* pixas, float minscore, int threshold, int debug);
         ...
         internal static  extern PIXA* pixaModifyStrokeWidth(PIXA* pixas, float targetw);
         internal static  extern PIX* pixModifyStrokeWidth(PIX* pixs, float width, float targetw);
         internal static  extern PIXA* pixaSetStrokeWidth(PIXA* pixas, int width, int thinfirst, int connectivity);
         ...
         internal static  extern PIXA* pixaAddTextNumber(PIXA* pixas, L_BMF* bmf, NUMA* na, uint val, int location);
         internal static  extern PIXA* pixaAddTextlines(PIXA* pixas, L_BMF* bmf, SARRAY* sa, uint val, int location);
         ...
         internal static  extern PIXA* pixaReadMultipageTiff( const char* filename );
         ...
         internal static  extern PIXA* pixaReadMemMultipageTiff( const l_uint8* data, size_t size );
